...
const HighlightedButton = ({ textValue }) => {
    return (
        <button
        className="rounded-lg flex items-center gap-2 px-3 py-2 bg-greenButtonBG box-border border-greenButtonBorder border-[2px] text-greenButtonText transition pointer-events-none ">
            {/* Icon */}
